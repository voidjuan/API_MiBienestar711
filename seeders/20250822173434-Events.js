      ...
      [
        {
          ...
          state: "Activo",
          maxCapacity: 100,
          categoryId: 21, // Deportes
          userId: 19,     // coord_andres
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
          ...
          state: "Activo",
          maxCapacity: 40,
          categoryId: 22, // Agricultura
          userId: 20,     // coord_paola
          createdAt: new Date(),
          updatedAt: new Date(),
        },
        {
